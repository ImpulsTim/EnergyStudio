function drawBDK(perKw,gA,gT,cos,gtvA,gtvT){
  ...
  var baseOpts={responsive:true,maintainAspectRatio:false,animation:false,plugins:{legend:{display:false}},scales:{x:Object.assign(ax('Tijdsduur (%)'),{ticks:Object.assign(ax().ticks,{maxTicksLimit:11})}),y:ax(_cv.unit)}};
